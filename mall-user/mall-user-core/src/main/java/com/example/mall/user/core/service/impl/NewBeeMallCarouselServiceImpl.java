...
import com.example.mall.user.api.service.NewBeeMallCarouselService;
import com.example.mall.user.api.vo.NewBeeMallIndexCarouselVO;
import com.example.mall.user.core.dao.CarouselMapper;
...
public class NewBeeMallCarouselServiceImpl implements NewBeeMallCarouselService {
    ...
    public PageResult getCarouselPage(PageQueryUtil pageUtil) {
        ...
        PageResult pageResult = new PageResult(carousels, total, (int) pageUtil.get("limit"), (int) pageUtil.get("page"));
        return pageResult;
    }
