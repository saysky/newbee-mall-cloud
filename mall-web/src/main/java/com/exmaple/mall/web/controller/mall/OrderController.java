...
import com.example.mall.goods.api.service.NewBeeMallShoppingCartService;
...
public class OrderController {
    ...
    public String saveOrder(HttpSession httpSession) {
        ...
        saveOrderDTO.setUser(user);
        saveOrderDTO.setMyShoppingCartItems(myShoppingCartItems);
        String saveOrderResult = newBeeMallOrderService.saveOrder(saveOrderDTO);
        //跳转到订单详情页
