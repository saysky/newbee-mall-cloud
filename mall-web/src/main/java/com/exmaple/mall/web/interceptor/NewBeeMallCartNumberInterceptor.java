package com.exmaple.mall.web.interceptor;
...
//            newBeeMallUserVO.setShopCartItemCount(newBeeMallShoppingCartItemMapper.selectCountByUserId(newBeeMallUserVO.getUserId()));
            newBeeMallUserVO.setShopCartItemCount(newBeeMallShoppingCartService.selectCountByUserId(newBeeMallUserVO.getUserId()));
