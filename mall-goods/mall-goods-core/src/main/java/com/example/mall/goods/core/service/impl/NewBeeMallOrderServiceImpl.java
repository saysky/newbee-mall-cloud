...
import com.example.mall.goods.api.entity.NewBeeMallOrderItem;
import com.example.mall.goods.api.entity.StockNumDTO;
import com.example.mall.goods.api.service.NewBeeMallOrderService;
import com.example.mall.goods.api.vo.*;
import com.example.mall.goods.core.dao.NewBeeMallGoodsMapper;
import com.example.mall.goods.core.dao.NewBeeMallOrderItemMapper;
import com.example.mall.goods.core.dao.NewBeeMallOrderMapper;
import com.example.mall.goods.core.dao.NewBeeMallShoppingCartItemMapper;
...
public class NewBeeMallOrderServiceImpl implements NewBeeMallOrderService {
    ...
    public String saveOrder(SaveOrderDTO saveOrderDTO) {
        NewBeeMallUserVO user = saveOrderDTO.getUser();
        List<NewBeeMallShoppingCartItemVO>  myShoppingCartItems = saveOrderDTO.getMyShoppingCartItems();
